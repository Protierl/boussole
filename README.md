...
**SIMULATION · cours réels · capital fictif** — mis à jour le 21/07/2026 à 18:43 (Paris) · sources : directes

## 🔴 9 894,00 €

**-106,00 € (-1,1 %)** · jour +1,6 % depuis le 12/07/2026

![Courbe de performance](courbe.png)

| Indicateur | Valeur | Indicateur | Valeur |
|---|---|---|---|
| Perf. annualisée | -34,5 % | Volatilité ann. | 15,3 % |
| Drawdown max | -2,7 % | Sharpe | -1,95 |
| Exposition | 97 % | Liquidités | 262,98 € |
| Trades clôturés | 16 (6 % gagnants) | Frais cumulés | 59,81 € |
| EUR/USD | 1,1414 | P&L réalisé | -239,42 € |

## Positions

| Actif | Qté | Cours | Valeur | P&L | Poids |
|---|---|---|---|---|---|
| **DBC** Panier mat. prem. | 96,208 | 29,54 $ | 2 489,48 € | +2,2 % | 25 % |
| **JPM** JPMorgan | 7,986 | 345,51 $ | 2 417,33 € | +0,3 % | 24 % |
| **QQQ** Nasdaq 100 | 3,459 | 709,08 $ | 2 148,67 € | -1,2 % | 22 % |
| **AAPL** Apple | 5,026 | 327,88 $ | 1 443,79 € | +3,9 % | 15 % |
| **USO** Pétrole WTI | 10,051 | 128,52 $ | 1 131,76 € | +4,1 % | 11 % |

## Signaux (classement momentum)

| # | Actif | Momentum | Tendance | Cible |
|---|---|---|---|---|
| 1 | **USO** Pétrole WTI | +42,7 % | ▲ | 11 % |
| 2 | **AAPL** Apple | +24,2 % | ▲ | 14 % |
| 3 | **DBC** Panier mat. prem. | +15,3 % | ▲ | 25 % |
| 4 | **QQQ** Nasdaq 100 | +11,9 % | ▲ | 21 % |
| 5 | **JPM** JPMorgan | +9,8 % | ▲ | 25 % |
| 6 | **EEM** Marchés émergents | +8,4 % | ▲ | — |
| 7 | **SPY** S&P 500 | +6,9 % | ▲ | — |
| 8 | **NVDA** Nvidia | +5,9 % | ▲ | — |
